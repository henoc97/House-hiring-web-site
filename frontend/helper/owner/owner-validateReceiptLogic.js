...
function validateReceiptLogic() {
  ...
  if (receiptData) {
    const toPay =
      receiptData.total_sumpayed * validateReceiptPrice < 200
        ? 200
        : receiptData.total_sumpayed * validateReceiptPrice; // Calculates the amount to pay for receipt validation
